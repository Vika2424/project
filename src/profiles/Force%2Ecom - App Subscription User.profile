...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_Drive__c.End_Drive__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_Drive__c.Opportunity__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Test_Drive__c.Price__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_Drive__c.Start_Drive__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_Drive__c.User__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Assign_manager_to_permission_set</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Contract</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Event</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Event_for_Opportunity</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Opportunity_Product</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Order</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_Test_Drive</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Create_an_opportunity</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Send_Email_When_Price_Becomes_Cheaper</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
